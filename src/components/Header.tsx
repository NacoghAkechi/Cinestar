        ...
        <div className="flex items-center h-full gap-12">
          ...
          >
            <Image
              ...
              alt="CineStar Logo"
              className="static h-full w-full text-transparent"
              sizes="100vw"
            />
          </a>
          ...
          <div className="flex items-center justify-center flex-1 gap-4">
            <Button
              href="#"
              icon={`${process.env.PUBLIC_URL}/images/icons/ic-ticket.svg`}
              className="hover:hover-color-white btn--pri"
            >
              {t("header.buyTicket")}
            </Button>
            <Button
              href="#"
              icon={`${process.env.PUBLIC_URL}/images/icons/ic-cor.svg`}
              className="btn--second text-gray-100"
            >
              {t("header.buyPopCorn")}
            </Button>
          </div>
          ...
          <div className="flex items-center gap-8">
            <div className="relative">
              <div className="toggleBtn flex items-center justify-center border-2 border-white rounded-full cursor-pointer h-[2.4rem] w-[2.4rem] lg:hidden sm:hidden">
                <Image
                  src={`${process.env.PUBLIC_URL}/images/icons/icon-search.svg`}
                  className="text-transparent w-1/2"
                  width="15"
                  height="15"
                />
              </div>
                  ...
                  <div>
                    <div className="flex items-center relative">
                      ...
                      <button type="submit" className="absolute right-4 w-4">
                        <Image
                          src={`${process.env.PUBLIC_URL}/images/icons/ic-header-search.svg`}
                          className="text-transparent w-full"
                          width="15"
                          height="15"
                        />
                      </button>
            ...
            <div className="min-w-[120px] desktop">
              <div className="flex items-center relative gap-1 cursor-pointer top-[-0.2rem]">
                <div className="flex-shrink-0 h-6 relative w-6">
                  <img
                    src={`${process.env.PUBLIC_URL}/images/icons/ic-header-auth.svg`}
      ...
      <div className="h-16">
        <div className="flex items-center relative cursor-pointer gap-4 h-full justify-between container mx-auto px-4 border-t border-gray-300">
          <div className="flex gap-16">
            <div className="group">
              ...
              <div className="absolute left-0 top-full w-full grid grid-cols-3 overflow-hidden p-6 pt-4 pb-4 gap-y-2 text-white bg-[#0f172a] border-[0.1rem] border-[rgba(248,250,252,0.1)] rounded-[0.4rem] opacity-0 translate-y-2 transition-all duration-300 ease-in-out invisible group-hover:opacity-100 group-hover:translate-y-0 group-hover:visible">
                <a
                  className="flex items-center gap-4 px-4 py-3 transition-all duration-300 ease-in-out whitespace-nowrap w-full hover:hover-color"
                  href="#"
                >
                  {t("location.locat1")}
                </a>
          ...
          <div className="flex items-center gap-6 text-default-color">
            <a
              className="flex items-center gap-4 px-4 py-3 transition-all duration-300 ease-in-out whitespace-nowrap w-full hover:underline-position-under hover:hover-color"
              href="#"
            >
              {t("nav.discount")}
            </a>
