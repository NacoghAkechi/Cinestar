    ...
    <div className="App bg-[#0f172a]">
      ...
      <div className="mt-40 bg-[#0f172a] px-32 w-600">
        <div className="justify-left items-left h-full">
          ...
          <div className="w-full w-2/5 bg-white shadow-lg rounded-b-lg p-8 w-full">
            {activeTab === "login" && (
            ...
            {activeTab === "register" && (
              <div className="auth-form space-y-4">
                ...
                <button
                  ...
                  className="w-full px-4 py-2 bg-gradient-to-r from-yellow-500 to-purple-500 text-white rounded-lg hover:bg-gradient-to-r hover:from-blue-500 hover:to-cyan-500 transition duration-150 ease-in-out"
                >
                  Đăng ký
                </button>
              </div>
